    ...
    <div className="h-screen overflow-y-scroll text-white font-sans bg-[url('/bg-img.png')] bg-cover bg-center bg-no-repeat">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 pb-20">
        <div className="w-full max-w-2xl flex flex-col items-center">
          <div className="flex items-center gap-2 rounded-full border border-white/20 bg-white/10 p-1.5 pr-3 backdrop-blur-md text-[13px] text-white/90">
          ...
          <h1 className="mt-6 text-center text-4xl md:text-6xl font-semibold leading-tight">
            Let's build your app together
          </h1>

          <p className="mt-5 max-w-xl text-center text-sm md:text-base leading-7 text-white/70">
